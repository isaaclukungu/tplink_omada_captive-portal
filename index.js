...
// ================================================================
// Greeting banner: dynamic "Good Morning/Afternoon/Evening" + live
// date/time. Purely cosmetic — does not touch any Omada auth logic
// above.
// ================================================================
...
function updateGreetingClock() {
    ...
    if (dateEl) {
        ...
        dateEl.textContent = "Today is " + weekday;
    }
    if (timeEl) {
